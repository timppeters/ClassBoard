<template>
  <div class="room">
    ...
    <div class="topbar" v-bind:class="topbarSize">
      ...
      <div class="button wrong" v-on:click="markBoard('wrong')" v-if="userType=='leader'" v-bind:class="{ hide : currentBoard!='user' || !leader.submittedUsers.includes(leader.selectedUserBoard) || leader.markedUsers.includes(leader.selectedUserBoard)}" key="markWrong">wrong</div>
    </div>
